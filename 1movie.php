...
<head>
  ...
  <style>
    * {
    ...
    .hero {
      height: 100vh;
      background: url('goodbadugly.jpg') center center/cover no-repeat;
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <h1>GOOD BAD UGLY</h1>
      <div class="ratings">⭐ 5 (IMDB) | ⏱ 2hr 30mins</div>
      <p><strong style="color: white">Release Date:</strong> APRIL 10,2025</p>
      <p>In a brutal quest for buried gold, three outlaws—each with their own code—clash across a war-torn landscape...</p>
      <p><strong style="color: white">Cast:</strong> Ajith Kumar, Trisha Krishnan, Arjun Das, S.J.Suryah</p>
      <p><strong style="color: white">Genre:</strong> Action, Drama, Thriller</p>
    </div>
  </section>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.showtime').forEach(showtime => {
        showtime.addEventListener('click', function(e) {
          ...
          window.location.href = `seats.php?theatre=${encodeURIComponent(theatre)}&time=${encodeURIComponent(time)}&movie=GOOD%20BAD%20UGLY&day=${selectedDateData.day}&date=${encodeURIComponent(selectedDateData.date)}&full_date=${selectedDateData.full_date}`;
        });
      });
