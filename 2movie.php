...
$days = [
  ...
  ["day" => "Sun", "date" => "4 MAY", "full_date" => "2025-05-04"],
  ["day" => "Mon", "date" => "5 MAY", "full_date" => "2025-05-05"],
  ["day" => "Tue", "date" => "6 MAY", "full_date" => "2025-05-06"],
  ["day" => "Wed", "date" => "7 MAY", "full_date" => "2025-05-07"],
  ["day" => "Thu", "date" => "8 MAY", "full_date" => "2025-05-08"]
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      height: 100vh;
      background: url('retro2.jpg') center center/cover no-repeat;
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <h1>RETRO</h1>
      <div class="ratings">⭐ 4.5 (IMDB) | ⏱ 2hr 30mins</div>
      <p>Retro (subtitled Love, Laughter and War) is an upcoming Indian Tamil-language romantic action film written and directed by Karthik Subbaraj. Produced by Stone Bench Creations and 2D Entertainment, the film stars Suriya and Pooja Hegde in the lead roles.</p>
      <p><strong style="color: white ">Release Date:</strong>MAY 01,2025</p>
      <p><strong style="color: white">Cast:</strong> Suriya, Pooja Hegde, Prakash Raj </p>
      <p><strong style="color: white">Genre:</strong> Romance, Adventure</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.showtime').forEach(showtime => {
        showtime.addEventListener('click', function(e) {
          ...
          window.location.href = `seats.php?theatre=${encodeURIComponent(theatre)}&time=${encodeURIComponent(time)}&movie=RETRO&day=${selectedDateData.day}&date=${encodeURIComponent(selectedDateData.date)}&full_date=${selectedDateData.full_date}`;
        });
      });
