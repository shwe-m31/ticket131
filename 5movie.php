...
<head>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      height: 100vh;
      background: url('kingston2.jpg') center center/cover no-repeat;
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <h1>KINGSTON</h1>
      <div class="ratings">⭐ 4 (IMDB) | ⏱ 2hr 19mins</div>
      <p>When a fearless gangster-turned-kingpin rises from the streets of Kingston, his past comes back to haunt him. In a world of betrayal and bloodshed, can he hold the crown—or will it cost him everything?</p>
      <p><strong style="color: white ">Release Date:</strong>MARCH 07,2025</p>
      <p><strong style="color: white">Cast:</strong> G.V.Prakash Kumar, Divyabharathi</p>
      <p><strong style="color: white">Genre:</strong> Fantasy, Horror, Adventure</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.showtime').forEach(showtime => {
        showtime.addEventListener('click', function(e) {
          ...
          window.location.href = `seats.php?theatre=${encodeURIComponent(theatre)}&time=${encodeURIComponent(time)}&movie=KINGSTON&day=${selectedDateData.day}&date=${encodeURIComponent(selectedDateData.date)}&full_date=${selectedDateData.full_date}`;
        });
      });
