...
<head>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      height: 100vh;
      background: url('veera2.jpg') center center/cover no-repeat;
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <h1>VEERA DHEERA SOORAN</h1>
      <div class="ratings">⭐ 4.7 (IMDB) | ⏱ 2hr 30mins</div>
      <p>Kaali, a provision store owner and a loving husband and father, whose involvement in a dangerous crime network and his mysterious mission forms the rest of the story.</p>
      <p><strong style="color: rgb(38, 33, 33) ">Release Date:</strong>MARCH 27,2025</p>
      <p><strong style="color: rgb(38, 33, 33)">Cast:</strong> Vikram, Dushara Vijayan, S.J.Suryah</p>
      <p><strong style="color: rgb(38, 33, 33)">Genre:</strong> Adventure</p>
  ...
  <select id="price-filter">
    ...
    <select id="time-filter">
      ...
      <option value="10:00 AM">Sunrise Spectacle</option>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.showtime').forEach(showtime => {
        showtime.addEventListener('click', function(e) {
          ...
          window.location.href = `seats.php?theatre=${encodeURIComponent(theatre)}&time=${encodeURIComponent(time)}&movie=VEERA%20DHEERA%20SOORAN&day=${selectedDateData.day}&date=${encodeURIComponent(selectedDateData.date)}&full_date=${selectedDateData.full_date}`;
        });
      });
